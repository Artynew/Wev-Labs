...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react7.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime5.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react9.cloneElement)(children, triggerProps), (0, import_jsx_runtime4.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
//# sourceMappingURL=chunk-VWXLMCFT.js.map
